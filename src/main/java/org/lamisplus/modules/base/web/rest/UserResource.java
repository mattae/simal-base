...
import org.lamisplus.modules.base.web.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
        ...
        } else if (userRepository.findOne(emailMatches(userDTO.getEmail())).isPresent()) {
            ...
            return ResponseEntity.created(new URI("/api/users/" + newUser.getUsername()))
                .headers(HeaderUtil.createAlert(APPLICATION_NAME, "userManagement.created", newUser.getUsername()))
                .body(newUser);
        }
    }
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        ...
        return ResponseUtil.wrapOrNotFound(updatedUser,
            HeaderUtil.createAlert(APPLICATION_NAME, "userManagement.updated", userDTO.getUsername()));
    }
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable String login) {
        ...
        return ResponseEntity.noContent().headers(HeaderUtil.createAlert(APPLICATION_NAME, "userManagement.deleted", login)).build();
    }
}
